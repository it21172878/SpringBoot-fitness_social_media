...
import com.fitness_social_media.fitness_social_media.service.ReelsService;
...
public class ReelsController {
    ...
    public Reels creatReels(@RequestBody Reels reel,@RequestHeader("Authorization") String jwt){
